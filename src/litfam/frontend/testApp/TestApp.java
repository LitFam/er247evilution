...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			queryBuilder.computeRandomTermedBusinessQuery(TEST_TERM, NO_OFFSET, TEST_LATITUDE, TEST_LONGITUDE);
			businessList = client.queryClientForBusinesses(queryBuilder);
			...
			queryBuilder.computeRandomTermedBusinessQuery(TEST_TERM, offset, TEST_LATITUDE, TEST_LONGITUDE);
